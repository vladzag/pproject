...
public class UXTests {
    ...
    public static final By weatherTomorrowStPetSelector = new By.ByCssSelector("body > header > div.header-subnav > div.header-container.wrap > div > div.subnav > div > a:nth-child(3)");
}