...
public class NewsPageGismeteo extends DefaultPage {
    ...
    public static final By linksList = new By.ByCssSelector("body > header > div.header-subnav > div.header-container.wrap > div > div");
    ...
    public static final By readMoreNewsFirstColumnTabSelector = new By.ByCssSelector("body > section > div.content-column.column1 > section.section.section-content.section-visible > div.btn.btn-width-100.btn-lightblue.js-news-load");
    public static final By topSevenNewsSelector = new By.ByCssSelector("body > section > div.content-column.column1 > section:nth-child(1) > div");
